...
<form name="ahofeed_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
	...
	<p><?php _e("Delivery Sites URL: " ); ?><input type="text" name="ahofeed_delivery_sites_url" value="<?php echo $ahofeed_delivery_sites_url; ?>" size="100"><?php _e(" eg: http://my.abundantharvestorganics.com/json/delivery_sites.php" ); ?></p>
	
	<p><?php _e("Case Contents URL: " ); ?><input type="text" name="ahofeed_case_contents_url" value="<?php echo $ahofeed_case_contents_url; ?>" size="100"><?php _e(" eg: http://my.abundantharvestorganics.com/json/case_contents.php" ); ?></p>
